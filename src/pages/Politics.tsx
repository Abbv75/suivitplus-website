  ...
  const sections = [
    {
      ...
      content: [
        "Chez Suvixy, nous accordons une importance capitale à la protection de vos données personnelles. Cette politique de confidentialité décrit comment nous collectons, utilisons et protégeons les informations que vous nous fournissez lors de l'utilisation de notre application de transport.",
    ...
    },
    {
      ...
      content: [
        "Suvixy met en œuvre des mesures de sécurité techniques et organisationnelles appropriées pour protéger vos données personnelles contre tout accès non autorisé, modification, divulgation ou destruction.",
    ...
    },
    {
      ...
      content: [
        "Suvixy propose plusieurs types de services avec une tarification transparente :",
    ...
    },
    {
      ...
      content: [
        "En utilisant l'application ou le site web Suvixy, vous acceptez nos conditions d'utilisation. Vous vous engagez à :",
        ...
        "• Respecter les chauffeurs et le personnel de Suvixy.",
      ],
    },
    {
      icon: AlertTriangle,
      ...
      content: [
        "Suvixy s'efforce d'assurer l'exactitude des informations mais ne peut garantir l'absence totale d'erreurs techniques ou d'imprécisions sur les estimations de temps de trajet.",
        "Suvixy décline toute responsabilité pour toute interruption de service indépendante de sa volonté.",
      ],
    },
    {
      icon: MessageCircle,
    ...
    <div className="min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          >
            Découvrez comment Suvixy protège vos données personnelles et garantit votre sécurité lors de l'utilisation de nos services.
          </motion.p>
        </div>
      </section>
